...
We strongly recommend you use our `baserow/baserow:2.1.2` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:2.1.2`
    and `baserow/web-frontend:2.1.2` images.
...
* The all-in-one Baserow image `baserow/baserow:2.1.2`
...
* Our standalone `baserow/backend:2.1.2` and `baserow/web-frontend:2.1.2` images with
...
If you are using the `baserow/backend:2.1.2` image then you can do this by adding
