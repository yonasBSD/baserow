...
We strongly recommend you use our `baserow/baserow:2.1.1` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:2.1.1`
    and `baserow/web-frontend:2.1.1` images.
...
* The all-in-one Baserow image `baserow/baserow:2.1.1`
...
* Our standalone `baserow/backend:2.1.1` and `baserow/web-frontend:2.1.1` images with
...
If you are using the `baserow/backend:2.1.1` image then you can do this by adding
